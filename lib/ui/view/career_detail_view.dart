...
class CareerDetailView extends StatefulWidget {
  CareerModel? data;
  ...
  @override
  _CareerDetailViewState createState() => _CareerDetailViewState();
}

class _CareerDetailViewState extends State<CareerDetailView> {
  @override
  void initState() {
    super.initState();
  }
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Html(
                data: """
                  ${widget.data!.career_description}
                      """,
              )
